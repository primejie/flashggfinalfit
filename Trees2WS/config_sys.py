...
trees2wsCfg = {
  ...
  'mainVars':["CMS_hgg_mass","Dijet_mass","weight","dZ","*sigma"], # Vars to add to nominal RooDatasets
  'dataVars':["CMS_hgg_mass","Dijet_mass","weight"], # Vars for data workspace (trees2ws_data.py script)
  ...
  'systematics':['fnuf', 'JER', 'JES', 'material', 'scale', 'smear','FJER','FJES'],
